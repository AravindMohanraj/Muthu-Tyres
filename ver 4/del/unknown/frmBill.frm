...
'############### Head Printing #################
  '  Print #1,
    'Print #1,
    Print #1, Space(0) + Space(24) + RPad(Left(Trim(txtBno.Text), 6), 6) + " B.O.III" + Space(3) + CPad(Mid(cboPaytype.Text, 4, Len(cboPaytype.Text)), 11) + Space(13) + dBilldt.FormattedText
        Print #1,
  ...
  '         Print #1, Space(nLM) + Space(3) + RPad(flxgrd.TextMatrix(i, 0), 2) + RPad(flxgrd.TextMatrix(i, 1), 6) + RPad(flxgrd.TextMatrix(i, 2), 5) + RPad(flxgrd.TextMatrix(i, 3), 6) + RPad(flxgrd.TextMatrix(i, 4), 6)
   '        Print #1, Space(nLM) + Space(3) + RPad(Mid(flxgrd.TextMatrix(i, 1), 15, Len(flxgrd.TextMatrix(i, 1))), 5)
    ...
    End If
        ...
        nCnt = nCnt + 1
        Print #1, Space(nLM) + Space(11) + "VAT @ " + LPad(txtTaxP, 4) + " %" + Space(33) + LPad(Format(txtTaxR, "#####0.00"), 9)
